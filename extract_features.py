...
class FeatureExtractor:
    ...
    def extract_features_from_dataset(self, clip_index_path: str = "clip_index.csv") -> str:
        """
...
def main():
    ...
    parser.add_argument("--clips-dir", default="spikes", 
                       help="Directory containing audio clips")
    parser.add_argument("--output-dir", default="features", 
                       help="Output directory for features")
    parser.add_argument("--clip-index", default="clip_index.csv",
