...
class Trainer:
    ...
    def __init__(self, config, train_loader, val_loader, device='cpu'):
        ...
        # Get class weights from data loader
    ...
    def train(self, num_epochs, save_dir='checkpoints'):
        ...
        for epoch in range(num_epochs):
            ...
            # Early stopping check - only save best model
...
def main():
    ...
    try:
        # Configuration - CONSERVATIVE model to prevent overfitting
        config = CNNConfig(
            n_mels=128,
            n_time_frames=173,
            num_classes=1,
            dropout_rate=0.7,  # Higher dropout for regularization
        ...
        train_loader, val_loader = create_data_loaders(
            ...
            augment_train=True  # Enable data augmentation to prevent overfitting
        )
        ...
        trainer.train(num_epochs=30, save_dir='checkpoints')
